...
def analisis_meteo():
    ...
    doc = {
            ...
            'R2 RF': r2_RF_temperatura,
            'R2 RN': r2_RN_temperatura,
    ...
    doc = {
            ...
            'R2 RF': r2_RF_precipitaciones,
            'R2 RN': r2_RN_precipitaciones,
    ...
    doc = {
            ...
            'R2 RF': r2_RF_vel_media_viento,
            'R2 RN': r2_RN_vel_media_viento,
    ...
    doc = {
            ...
            'R2 RF': r2_RF_direccion_viento,
            'R2 RN': r2_RN_direccion_viento,
    ...
    for doc in config.array_dic_analisis_datos_meteo:
        ...
        bdd.coleccion_analisis_meteo.update_one({'_id': doc['medida']}, {'$set': doc}, upsert=True)