...
def API_meterId_pags():
    ...
    #url_meterId_pags = 'https://api.euskadi.eus/traffic/v1.0/meters/byProvince/20'
    # Solcitud
...
def API_meterId():
    ...
    #url_meterId = f'https://api.euskadi.eus/traffic/v1.0/meters/byProvince/20?_page={config.num_pag_meter}'
    # Solcitud
...
def API_flows(meterId, year_month, dia_sem):
    # API de flows
    url_flows = f'https://api.euskadi.eus/traffic/v1.0/flows/byMonth/{year_month[0]}/{year_month[1]}/byMeter/{meterId}/byDayOfWeek/{dia_sem}'
    # Solcitud
